    ...
    public partial class aspxJobTitles : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("jobtitle_delete", new SqlConnection(GetConnectionString()));
                System.Diagnostics.Debug.WriteLine("@v_txtJtCode =====>" + v_txtJtCode);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_jt_code", v_txtJtCode));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean JobTitles_Update()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("jobtitles_update", new SqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_jt_code", v_JtCode));
                cmd.Parameters.Add(new SqlParameter("@v_sht_desc", txtJtShtDesc.Text));
                cmd.Parameters.Add(new SqlParameter("@v_desc", txtDesc.Text));
                cmd.Parameters.Add(new SqlParameter("@v_jtcode", SqlDbType.Int));
