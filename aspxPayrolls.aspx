                    ...
                    <asp:Panel ID="pnlEditingData" runat="server" Wrap="False" Visible="False" 
                        BackColor="#99CCFF">                        
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblPostPayroll" runat="server" Text="Post to Finance : "></asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlPostPayroll" runat="server" Width="60px" Enabled="true"  style="visibility:visible"
                                            ForeColor="Black" >
                    ...
                    <asp:Panel ID="pnlDisplayAllRecs" runat="server" Wrap="False" Visible=true 
                        ...
                        <asp:GridView ID="GridView1" runat="server" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="pr_post_payroll" HeaderText="Post" 
                                    SortExpression="pr_post_payroll" />
