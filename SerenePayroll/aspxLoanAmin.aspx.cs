    ...
    public partial class aspxLoanAmin : System.Web.UI.Page
    {
        ...
        private Boolean Emp_Pay_Element_Update()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.update_emp_pay_elements", new MySqlConnection(GetConnectionString()));

                //TODOTODOTODOTODOTODOTODOTODOTODOTODOTODO
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_epe_code", 0));
                cmd.Parameters.Add(new MySqlParameter("v_emp_code", v_EmpCode));
                cmd.Parameters.Add(new MySqlParameter("v_pel_code", 0));
                cmd.Parameters.Add(new MySqlParameter("v_amt", 0));
                cmd.Parameters.Add(new MySqlParameter("v_created_by", ""));
                cmd.Parameters.Add(new MySqlParameter("v_epecode", MySqlDbType.Int32));
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd = new MySqlCommand("serenehrdb.update_emp_loans", new MySqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_el_code", v_el_code));
                cmd.Parameters.Add(new MySqlParameter("v_emp_code", v_emp_code));
                cmd.Parameters.Add(new MySqlParameter("v_eff_date", txt_el_eff_date.Text));
                cmd.Parameters.Add(new MySqlParameter("v_loan_applied_amt", v_loan_applied_amt));

                cmd.Parameters.Add(new MySqlParameter("v_service_charge", v_service_charge));
                cmd.Parameters.Add(new MySqlParameter("v_done_by", v_user));
                cmd.Parameters.Add(new MySqlParameter("v_lt_code", v_lt_code));
                cmd.Parameters.Add(new MySqlParameter("v_elcode", MySqlDbType.Int32));
                cmd.Parameters["v_elcode"].Direction = ParameterDirection.Output;
                cmd.Parameters.Add(new MySqlParameter("v_tot_instalments", v_tot_instalments));
                cmd.Parameters.Add(new MySqlParameter("v_instalment_amt", v_instalment_amt));
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd = new MySqlCommand("serenehrdb.process_emp_loan", new MySqlConnection(GetConnectionString()));
        ...
        protected void btnAuthoriseLoan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd = new MySqlCommand("serenehrdb.auth_emp_loan", new MySqlConnection(GetConnectionString()));
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd = new MySqlCommand("serenehrdb.delete_emp_loan", new MySqlConnection(GetConnectionString()));
