                        ...
                        BackColor="#99CCFF">                        
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtBnkName" runat="server" Width="400" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPostalAddr" runat="server" Width="400" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPhysicalAddr" runat="server" Width="400" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtKBAcode" runat="server" Width="217" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
