    ...
    public partial class aspxPayrolls : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.delete_payroll", new MySqlConnection(GetConnectionString()));
                System.Diagnostics.Debug.WriteLine("v_txtPrCode =====>" + v_txtPrCode);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_pr_code", v_txtPrCode));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean Payroll_Update()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.update_payroll", new MySqlConnection(GetConnectionString()));
                ...
                cmd.Parameters.Add(new MySqlParameter("v_org_code", ddlOrg.SelectedValue));
                cmd.Parameters.Add(new MySqlParameter("v_wef", txtWef.Text));
                cmd.Parameters.Add(new MySqlParameter("v_wet", txtWet.Text));
                cmd.Parameters.Add(new MySqlParameter("v_prcode", MySqlDbType.Int32));
                cmd.Parameters["v_prcode"].Direction = ParameterDirection.Output;
                cmd.Parameters.Add(new MySqlParameter("v_day1_hrs", v_day1_hrs));
                cmd.Parameters.Add(new MySqlParameter("v_day2_hrs", v_day2_hrs));
                cmd.Parameters.Add(new MySqlParameter("v_day3_hrs", v_day3_hrs));
                cmd.Parameters.Add(new MySqlParameter("v_day4_hrs", v_day4_hrs));
                cmd.Parameters.Add(new MySqlParameter("v_day5_hrs", v_day5_hrs));
                cmd.Parameters.Add(new MySqlParameter("v_day6_hrs", v_day6_hrs));
                cmd.Parameters.Add(new MySqlParameter("v_day7_hrs", v_day7_hrs));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
