    ...
    public partial class aspxSystemPrivilages : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.delete_user_privillages", new MySqlConnection(GetConnectionString()));
                System.Diagnostics.Debug.WriteLine("v_txtUpCode =====>" + v_txtUpCode);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_up_code", v_txtUpCode));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean Privillage_Update()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.update_user_privillages", new MySqlConnection(GetConnectionString()));
                ...
                cmd.Parameters.Add(new MySqlParameter("v_upcode", MySqlDbType.Int32));
                cmd.Parameters["v_upcode"].Direction = ParameterDirection.Output;
                cmd.Parameters.Add(new MySqlParameter("v_type", ddlType.Text));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
