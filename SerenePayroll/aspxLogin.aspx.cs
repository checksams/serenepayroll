    ...
    public partial class aspxLogin : System.Web.UI.Page
    {
        ...
        private bool ValidateUser( string userName, string passWord )
        {
	        ...
	        try
	        {
                ...
                mysqlConn = new MySqlConnection("server=localhost;User Id=root;database=serenehrdb;Persist Security Info=True");
                mysqlConn.Open();
                ...
                mysqlCmm = new MySqlCommand("Select usr_pwd from shr_users where usr_name=@userName and usr_pwd=MD5(@pwd)", mysqlConn);
                mysqlCmm.Parameters.Add("@userName",MySqlDbType.VarChar);
                mysqlCmm.Parameters["@userName"].Value = userName;

                mysqlCmm.Parameters.Add("@pwd", MySqlDbType.VarChar);
