    ...
    public partial class aspxEmpPayElements : System.Web.UI.Page
    {
        ...
        private Boolean Emp_Pay_Element_Update()
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new MySqlParameter("v_ot_hours", 0));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        protected void GridView2_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            try
            {
                ...
                cmd = new MySqlCommand("serenehrdb.update_emp_pay_elements", new MySqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_epe_code", v_epe_code));
                cmd.Parameters.Add(new MySqlParameter("v_emp_code", null));
                cmd.Parameters.Add(new MySqlParameter("v_pel_code", null));
                cmd.Parameters.Add(new MySqlParameter("v_amt", v_epe_amt));
                cmd.Parameters.Add(new MySqlParameter("v_created_by", v_user));
                cmd.Parameters.Add(new MySqlParameter("v_epecode", MySqlDbType.Int32));
                cmd.Parameters["v_epecode"].Direction = ParameterDirection.Output;
                cmd.Parameters.Add(new MySqlParameter("v_ot_hours", v_ot_hours));
        ...
        protected void GridView2_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                cmd = new MySqlCommand("serenehrdb.delete_emp_pay_elements", new MySqlConnection(GetConnectionString()));
        ...
        protected void btnSaveAddedPayElement_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new MySqlParameter("v_epe_code", v_epe_code));
                cmd.Parameters.Add(new MySqlParameter("v_emp_code", v_EmpCode));
                cmd.Parameters.Add(new MySqlParameter("v_pel_code", ddlPelCode.SelectedValue));
