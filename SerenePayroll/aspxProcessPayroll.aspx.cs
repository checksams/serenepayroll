    ...
    public partial class aspxProcessPayroll : System.Web.UI.Page
    {
        ...
        protected void btnPopPayroll_Click(object sender, EventArgs e)
        {
            ...
            try {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.populate_prd_pay_elements", new MySqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_pr_code", v_pr_code));
                cmd.Parameters.Add(new MySqlParameter("v_created_by", v_user));
                cmd.Parameters.Add(new MySqlParameter("v_month", ddlMonth.SelectedValue));
                cmd.Parameters.Add(new MySqlParameter("v_year", ddlYear.SelectedValue));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        protected void btnProcessPayroll_Click(object sender, EventArgs e)
        {
            ...
            try {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.process_payroll", new MySqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_tr_code", v_tr_code));
                cmd.Parameters.Add(new MySqlParameter("v_processed_by", v_user));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
