    ...
    public partial class aspxTaxes : System.Web.UI.Page
    {
        ...
        private Boolean Taxes_Update()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.update_taxes", new MySqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_tx_code", v_TxCode));
                ...
                cmd.Parameters.Add(new MySqlParameter("v_txcode", MySqlDbType.Int32));
