    ...
    public partial class aspxSystemRoles : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.delete_user_roles", new MySqlConnection(GetConnectionString()));
                System.Diagnostics.Debug.WriteLine("v_txtUrCode =====>" + v_txtUrCode);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_ur_code", v_txtUrCode));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean Privillage_Update()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.update_user_roles", new MySqlConnection(GetConnectionString()));
                ...
                cmd.Parameters.Add(new MySqlParameter("v_urcode", MySqlDbType.Int32));
        ...
        protected void btnGrant_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (GridViewRow row in GridView2.Rows)
                {
                    ...
                    {
                        cmd = new MySqlCommand("serenehrdb.update_user_role_privlg", new MySqlConnection(GetConnectionString()));

                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add(new MySqlParameter("v_urp_code", null));
                        cmd.Parameters.Add(new MySqlParameter("v_up_code", v_UpCode));
                        cmd.Parameters.Add(new MySqlParameter("v_ur_code", v_UrCode));
                        cmd.Parameters.Add(new MySqlParameter("v_min_amt", v_min_amt));
                        cmd.Parameters.Add(new MySqlParameter("v_max_amt", v_max_amt));
                        cmd.Parameters.Add(new MySqlParameter("v_urpcode", MySqlDbType.Int32));
        ...
        protected void btnRevoke_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (GridViewRow row in GridView3.Rows)
                {
                    ...
                    {
                        cmd = new MySqlCommand("serenehrdb.delete_user_role_privlg", new MySqlConnection(GetConnectionString()));

                        System.Diagnostics.Debug.WriteLine("gggggggg");
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add(new MySqlParameter("v_urp_code", v_urp_code));
                        cmd.Connection.Open();
                        cmd.ExecuteNonQuery();
