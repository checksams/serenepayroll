    ...
    public partial class aspxBanks : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.delete_banks", new MySqlConnection(GetConnectionString()));
                System.Diagnostics.Debug.WriteLine("v_txtBnkCode =====>" + v_txtBnkCode);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_bnk_code", v_txtBnkCode));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean Bank_Update() {
            ...
            try {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.update_banks", new MySqlConnection(GetConnectionString()));
                ...
                cmd.Parameters.Add(new MySqlParameter("v_name", txtBnkName.Text));
                cmd.Parameters.Add(new MySqlParameter("v_postal_address", txtPostalAddr.Text));
                cmd.Parameters.Add(new MySqlParameter("v_physical_address", txtPhysicalAddr.Text));
                cmd.Parameters.Add(new MySqlParameter("v_kba_code", txtKBAcode.Text));
                cmd.Parameters.Add(new MySqlParameter("v_bnkcode", MySqlDbType.Int32));
        ...
        private Boolean BankBranch_Update()
        {
            ...
            try
            {
                ...
                cmd = new MySqlCommand("serenehrdb.update_bank_branches", new MySqlConnection(GetConnectionString()));
                
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_bbr_code", v_bbr_code));
                cmd.Parameters.Add(new MySqlParameter("v_sht_desc", v_bbr_sht_desc));
                cmd.Parameters.Add(new MySqlParameter("v_name", v_bbr_name));
                cmd.Parameters.Add(new MySqlParameter("v_postal_address", v_bbr_postal_address));
                cmd.Parameters.Add(new MySqlParameter("v_physical_address", v_bbr_physical_address));
                cmd.Parameters.Add(new MySqlParameter("v_tel_no1", v_bbr_tel_no1));
                cmd.Parameters.Add(new MySqlParameter("v_tel_no2", v_bbr_tel_no2));
                cmd.Parameters.Add(new MySqlParameter("v_bnk_code", v_bnk_code));
                cmd.Parameters.Add(new MySqlParameter("v_bbrcode", MySqlDbType.Int32));
        ...
        protected void GridView2_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            cmd = new MySqlCommand("serenehrdb.delete_bank_branches", new MySqlConnection(GetConnectionString()));
            ...
            {   MySqlCommand cmd;
                ...
                if (dt.Columns.Count != 0)
                {
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        cmd = new MySqlCommand("serenehrdb.update_banks", new MySqlConnection(GetConnectionString()));

                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Clear();
                        cmd.Parameters.Add(new MySqlParameter("v_bnk_code", 0));
                        cmd.Parameters.Add(new MySqlParameter("v_sht_desc", str_bnk_sht_desc));
                        cmd.Parameters.Add(new MySqlParameter("v_name", str_bnk_name));
                        cmd.Parameters.Add(new MySqlParameter("v_postal_address", null));
                        cmd.Parameters.Add(new MySqlParameter("v_physical_address", null));
                        cmd.Parameters.Add(new MySqlParameter("v_kba_code", str_bnk_kba_code));
                        cmd.Parameters.Add(new MySqlParameter("v_bnkcode", MySqlDbType.Int32));
                        cmd.Parameters["v_bnkcode"].Direction = ParameterDirection.Output;
                        ...
                        if (v_bnkcode != 0) {
                            ...
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.Clear();
                            cmd.Parameters.Add(new MySqlParameter("v_bbr_code", 0));
                            cmd.Parameters.Add(new MySqlParameter("v_sht_desc", str_bbr_sht_desc));
                            cmd.Parameters.Add(new MySqlParameter("v_name", str_bbr_name));
                            cmd.Parameters.Add(new MySqlParameter("v_postal_address", str_bbr_postal_address));
                            cmd.Parameters.Add(new MySqlParameter("v_physical_address", str_bbr_physical_address));
                            cmd.Parameters.Add(new MySqlParameter("v_tel_no1", str_bbr_tel_no1));
                            cmd.Parameters.Add(new MySqlParameter("v_tel_no2", str_bbr_tel_no2));
                            cmd.Parameters.Add(new MySqlParameter("v_bnk_code", v_bnkcode));
                            cmd.Parameters.Add(new MySqlParameter("v_bbrcode", MySqlDbType.Int32));
                            cmd.Parameters["v_bbrcode"].Direction = ParameterDirection.Output;
        ...
        protected void btnDeleteAll_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand("serenehrdb.delete_all_bank_branches", new MySqlConnection(GetConnectionString()));
                    System.Diagnostics.Debug.WriteLine("v_txtBnkCode =====>" + v_txtBnkCode);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new MySqlParameter("v_bnk_code", v_txtBnkCode));
                    cmd.Connection.Open();
        ...
        protected void btnDeleteAllBankDtls_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("serenehrdb.delete_all_bank_details", new MySqlConnection(GetConnectionString()));
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
                cmd.Connection.Close();
