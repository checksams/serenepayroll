                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                                        ConnectionString="<%$ ConnectionStrings:serenehrdbConnectionString %>" 
                                                        ProviderName="<%$ ConnectionStrings:serenehrdbConnectionString.ProviderName %>" SelectCommand="SELECT `org_code`,`org_desc`
            FROM `serenehrdb`.`shr_organizations`
            where org_parent_org_code = 0 or org_parent_org_code is null
            "></asp:SqlDataSource>
                                                </td>
                                            </tr>
                                            <tr>
