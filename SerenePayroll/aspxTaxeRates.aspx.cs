    ...
    public partial class aspxTaxeRates : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenehrdb.delete_tax", new MySqlConnection(GetConnectionString()));
                System.Diagnostics.Debug.WriteLine("v_txtTxCode =====>" + v_txtTxCode);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_tx_code", v_txtTxCode));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean TaxesRates_Update()
        {
            ...
            try
            {
                ...
                for (int j = 0; j < GridView2.Rows.Count; j++)
                {
                    ...
                    cmd = new MySqlCommand("serenehrdb.update_tax_rates", new MySqlConnection(GetConnectionString()));

                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new MySqlParameter("v_txr_code", v_txr_code));
                    cmd.Parameters.Add(new MySqlParameter("v_desc", v_Desc));
                    cmd.Parameters.Add(new MySqlParameter("v_rate_type", v_rate_type));
                    ...
                    cmd.Parameters.Add(new MySqlParameter("v_range_from", v_range_from));
                    cmd.Parameters.Add(new MySqlParameter("v_range_to", v_range_to));
                    cmd.Parameters.Add(new MySqlParameter("v_tx_code", v_tx_code));
                    cmd.Parameters.Add(new MySqlParameter("v_txrcode", MySqlDbType.Int32));
                    cmd.Parameters["v_txrcode"].Direction = ParameterDirection.Output;
                    cmd.Parameters.Add(new MySqlParameter("v_frequency", v_frequency));
        ...
        protected void GridView2_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            cmd = new MySqlCommand("serenehrdb.delete_tax_rates", new MySqlConnection(GetConnectionString()));
            ...
            {   MySqlCommand cmd;
                ...
                if (dt.Columns.Count != 0)
                {
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        cmd.Parameters.Add(new MySqlParameter("v_txr_code", 0));
                        cmd.Parameters.Add(new MySqlParameter("v_desc", str_txr_desc));
                        cmd.Parameters.Add(new MySqlParameter("v_rate_type", str_txr_rate_type));
                        cmd.Parameters.Add(new MySqlParameter("v_rate", v_rate));
                        cmd.Parameters.Add(new MySqlParameter("v_div_factr", v_div_factr));
                        cmd.Parameters.Add(new MySqlParameter("v_wef", str_txr_wef));
                        cmd.Parameters.Add(new MySqlParameter("v_wet", str_txr_wet));
                        cmd.Parameters.Add(new MySqlParameter("v_range_from", v_range_from));
                        cmd.Parameters.Add(new MySqlParameter("v_range_to", v_range_to));
                        cmd.Parameters.Add(new MySqlParameter("v_tx_code", v_tx_code));
                        cmd.Parameters.Add(new MySqlParameter("v_txrcode", MySqlDbType.Int32));
                        cmd.Parameters["v_txrcode"].Direction = ParameterDirection.Output;
                        cmd.Parameters.Add(new MySqlParameter("v_frequency", str_txr_frequency));
        ...
        protected void btnDeleteAll_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand("serenehrdb.delete_all_tax_rates", new MySqlConnection(GetConnectionString()));
                    System.Diagnostics.Debug.WriteLine("v_txtTxCode =====>" + v_txtTxCode);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new MySqlParameter("v_tx_code", v_txtTxCode));
                    cmd.Connection.Open();
