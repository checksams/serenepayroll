...
{
    public partial class aspxPayrollEnquiry : System.Web.UI.Page
    {
        ...
        protected void btnPopPayroll_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                errMessage = ex.Message.ToString();
                errMessage = errMessage.ToString().Replace("'", "");
                Page.ClientScript.RegisterStartupScript(this.GetType(), "myScript", "MyJavaFunction('Populating records.','" + errMessage + "');", true);
                System.Diagnostics.Debug.WriteLine("ERROR =====>" + ex.Message + "..\n " + errMessage);
        ...
        protected void btnProcessPayroll_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                errMessage =  ex.Message.ToString();
                errMessage = errMessage.ToString().Replace("'", "");
                Page.ClientScript.RegisterStartupScript(this.GetType(), "myScript", "MyJavaFunction('Processing payroll.','" + errMessage + "');", true);
                System.Diagnostics.Debug.WriteLine("ERROR =====>" + ex.Message + "..\n " + errMessage);
        ...
        protected void lnkPaySlip2_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Debug.WriteLine("txtPrCode=" + txtPrCode.Text + " txtEmpCode=" + txtEmpCode.Text + " txtTrCode=" + txtTrCode.Text);
            rvPaySlip_001.LocalReport.ReportPath = "Reports/rptPaySlip_002.rdlc";
            rvPaySlip_001.LocalReport.Refresh();
            Page.ClientScript.RegisterStartupScript(this.GetType(), "myScript", "DisplayReports('Information.','Report ran successfully.');", true);
        ...
        protected void btnAuthPayroll_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                errMessage = "Error saving record ..." + ex.Message.ToString();
                errMessage = errMessage.ToString().Replace("'", "");
                Page.ClientScript.RegisterStartupScript(this.GetType(), "myScript", "MyJavaFunction('Authorizing Payroll.','" + errMessage + "');", true);
                System.Diagnostics.Debug.WriteLine("ERROR =====>" + ex.Message + "..\n " + errMessage);
        ...
        protected void btnAuthPayroll_Click1(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                errMessage = ex.Message.ToString();
                errMessage = errMessage.ToString().Replace("'", "");
                Page.ClientScript.RegisterStartupScript(this.GetType(), "myScript", "MyJavaFunction('Error authorising record','" + errMessage + "');", true);
                System.Diagnostics.Debug.WriteLine("ERROR =====>" + ex.Message + "..\n " + errMessage);
        ...
        protected void btnRollbackPayroll_Click(object sender, EventArgs e)
        {
            ...
            try{
                ...
                System.Diagnostics.Debug.WriteLine("txtTrCode===>" + txtTrCode.Text + " v_tr_code====>" + v_tr_code.ToString());
                SqlCommand cmd = new SqlCommand("rollback_payroll", new SqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_tr_code", v_tr_code));
                cmd.Parameters.Add(new SqlParameter("@v_rollback_by", v_user));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
                ...
                GridView4.DataSource = SqlDataSource4;
                GridView4.DataBind();
                Page.ClientScript.RegisterStartupScript(this.GetType(), "myScript", "MyJavaFunction('Information.','Payroll Rollback completed successfully');", true);
            }
            catch (Exception ex)
            {
                errMessage = ex.Message.ToString();
                errMessage = errMessage.ToString().Replace("'", "");
                Page.ClientScript.RegisterStartupScript(this.GetType(), "myScript", "MyJavaFunction('Error Rolling Back Payroll','" + errMessage + "');", true);
                System.Diagnostics.Debug.WriteLine("ERROR =====>" + ex.Message + "..\n " + errMessage);
