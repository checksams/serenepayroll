    ...
    public partial class aspxUsers : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("delete_user", new SqlConnection(GetConnectionString()));
                System.Diagnostics.Debug.WriteLine("@v_txtUsrCode =====>" + v_txtUsrCode);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_usr_code", v_txtUsrCode));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean User_Update()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update_users", new SqlConnection(GetConnectionString()));
                
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_usr_code", v_UsrCode));
                cmd.Parameters.Add(new SqlParameter("@v_name", txtname.Text));
                cmd.Parameters.Add(new SqlParameter("@v_full_name", txtFullName.Text));
                cmd.Parameters.Add(new SqlParameter("@v_emp_code", v_EmpCode));
                cmd.Parameters.Add(new SqlParameter("@v_pwd_reset", ddlPwdReset.SelectedValue.ToString()));
                cmd.Parameters.Add(new SqlParameter("@v_usrcode", SqlDbType.Int));
        ...
        {
            int v_UsrCode, v_UrCode, v_usg_code;
            String errMessage;
            ...
            try
            {
                ...
                foreach (GridViewRow row in GridView2.Rows)
                {
                    ...
                    {
                        cmd = new SqlCommand("update_user_roles_granted", new SqlConnection(GetConnectionString()));

                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@v_usg_code", v_usg_code));
                        cmd.Parameters.Add(new SqlParameter("@v_usr_code", v_UsrCode));
                        cmd.Parameters.Add(new SqlParameter("@v_ur_code", v_UrCode));
                        cmd.Parameters.Add(new SqlParameter("@v_created_by", v_user));
                        cmd.Parameters.Add(new SqlParameter("@v_usgcode", SqlDbType.Int));
        ...
        protected void btnRevoke_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (GridViewRow row in GridView3.Rows)
                {
                    ...
                    {
                        cmd = new SqlCommand("delete_user_roles_granted", new SqlConnection(GetConnectionString()));
