    ...
    public partial class aspxPayElements : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("delete_payelements", new SqlConnection(GetConnectionString()));
                System.Diagnostics.Debug.WriteLine("@v_txtPelCode =====>" + v_txtPelCode);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_pel_code", v_txtPelCode));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean PayElements_Update()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update_payelements", new SqlConnection(GetConnectionString()));
                int v_depends_on = -1;  //Depends on which  pay element
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_pel_code", v_PelCode));
                cmd.Parameters.Add(new SqlParameter("@v_sht_desc", txtShtDesc.Text));
                cmd.Parameters.Add(new SqlParameter("@v_desc", txtDesc.Text));
                cmd.Parameters.Add(new SqlParameter("@v_taxable", ddlTaxable.SelectedValue));
                cmd.Parameters.Add(new SqlParameter("@v_deduction", ddlDeduction.SelectedValue));
                cmd.Parameters.Add(new SqlParameter("@v_depends_on", v_depends_on));
                cmd.Parameters.Add(new SqlParameter("@v_type", ddlType.SelectedValue));
                cmd.Parameters.Add(new SqlParameter("@v_pelcode", SqlDbType.Int));
                cmd.Parameters["@v_pelcode"].Direction = ParameterDirection.Output;
                cmd.Parameters.Add(new SqlParameter("@v_applied_to", ddlAppliedTo.SelectedValue));
                cmd.Parameters.Add(new SqlParameter("@v_nontax_allowed_amt", v_NontaxAllowedAmt));
                cmd.Parameters.Add(new SqlParameter("@v_prescribed_amt", v_PrescribedAmt));
                cmd.Parameters.Add(new SqlParameter("@v_DrGLCode", txtDrGLCode.Text));
                cmd.Parameters.Add(new SqlParameter("@v_CrGLCode", txtCrGLCode.Text));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtDrGLCode.Text = GridView1.SelectedRow.Cells[12].Text.Trim().Replace("&nbsp;", "");
            txtCrGLCode.Text = GridView1.SelectedRow.Cells[13].Text.Trim().Replace("&nbsp;", "");
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                /*
                v_cnt = txtSearchShtDesc.Text.IndexOf('%');
                if (v_cnt < 0) { txtSearchShtDesc.Text = "%"; }
                v_cnt = txtSearchDesc.Text.IndexOf('%');
                if (v_cnt < 0) { txtSearchDesc.Text = "%"; }
                */
                GridView1.DataBind();
                GridView1.Visible = true;
            ...
            catch (Exception ex)
            {
                ...
                errMessage = errMessage.ToString().Replace("'", "");
                Page.ClientScript.RegisterStartupScript(this.GetType(), "myScript", "MyJavaFunction('Searching error.','" + errMessage + "');", true);
                System.Diagnostics.Debug.WriteLine("ERROR =====>" + ex.Message + "..\n " + errMessage);
        ...
        protected void btnAttachPyrll_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update_proll_pelements", new SqlConnection(GetConnectionString()));
        ...
        protected void populate_pe_fr_proll(int v_PelCode, int v_PrCode)
        {
            ...
            try
            {
                String v_user;
                Decimal v_amt;
                SqlCommand cmd = new SqlCommand("populate_pe_fr_proll", new SqlConnection(GetConnectionString()));
                ...
                {
                    v_amt = Convert.ToDecimal(txtPrescribedAmt.Text);
                }
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_pel_code", v_PelCode));
                cmd.Parameters.Add(new SqlParameter("@v_pr_code", v_PrCode));
        ...
        protected void proll_pelement_delete()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("delete_proll_pelements", new SqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_pp_code", v_pp_code));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        protected void btnPopulatePEtoEmp_Click(object sender, EventArgs e)
        {
            ...
            {
                String v_user;
                SqlCommand cmd = new SqlCommand("populate_pe_to_employees", new SqlConnection(GetConnectionString()));
                v_user = System.Web.HttpContext.Current.User.Identity.Name;
        ...
        protected void btnPostAmount_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("post_amt_to_employees", new SqlConnection(GetConnectionString()));
                v_user = System.Web.HttpContext.Current.User.Identity.Name;
        ...
        protected void imgbtnUpArrow_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    cmd = new SqlCommand("update_payelement_upwrds", new SqlConnection(GetConnectionString()));
        ...
        protected void imgbtnDownArrow_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                foreach (GridViewRow row in GridView1.Rows)
                {
                    cmd = new SqlCommand("update_payelement_downwrds", new SqlConnection(GetConnectionString()));
                    if (((CheckBox)row.FindControl("chkOrder")).Checked)
                    {
                        str_PelCode = row.Cells[1].Text.Trim().Replace("&nbsp;", "");
                        if (String.IsNullOrEmpty(str_PelCode))
        ...
        protected void ChckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (GridViewRow row in GridView1.Rows)
                {
                    ...
                    cmd = new SqlCommand("update_payelement_select", new SqlConnection(GetConnectionString()));
                    
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@v_pel_code", v_PelCode));
                    cmd.Parameters.Add(new SqlParameter("@v_select", v_select));
                    cmd.Connection.Open();
                    cmd.ExecuteNonQuery();
                    cmd.Connection.Close();
                    cmd.Dispose();
