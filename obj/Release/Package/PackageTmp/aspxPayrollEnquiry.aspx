<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="aspxPayrollEnquiry.aspx.cs" Inherits="SerenePayroll.aspxPayrollEnquiry" %>
                ...
                <div  style="height:inherit; border-spacing:3px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                        ...
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="ddlAuth" DefaultValue="YES" Name="v_status" 
                    ...
                    <asp:Panel ID="pnlEditingData" runat="server" Wrap="False" Visible="False" 
                        BackColor="#99CCFF">  
                            ...
                            <table style="width: 100px;">
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnRollbackPayroll" runat="server"
                                            Text="Rollback Payroll" onclick="btnRollbackPayroll_Click" />                                                                              
                                    </td>
                                    <td>
                                        <asp:Label ID="lblPayrollAuth" runat="server" Text="Authorized :" Font-Bold="True"></asp:Label>
                                        <asp:DropDownList ID="ddlAuth" runat="server" Width="60px" Enabled="False"  style="visibility:visible"
                                ...
                                <tr style="visibility:collapse" >
                                    <td>
                                        <asp:TextBox ID="txtDesc" runat="server" Width="217px"  style="visibility:collapse" 
                                            Enabled="False" ForeColor="Black"> </asp:TextBox>                                        
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlMonth" runat="server" Width="50px"  style="visibility:collapse"
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlYear" runat="server" Width="60px"  style="visibility:collapse"
                                            Enabled="False" ForeColor="Black">
                                        ...
                                        <asp:Button ID="btnPopPayroll" runat="server" onclick="btnPopPayroll_Click"  style="visibility:collapse"
                                            Text="Populate Payroll" />
                                        <asp:Button ID="btnProcessPayroll" runat="server"  style="visibility:collapse"
                                            Text="Process Payroll" onclick="btnProcessPayroll_Click" />
                                        <asp:Button ID="btnAuthPayroll" runat="server"  style="visibility:collapse"
