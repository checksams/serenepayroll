                                        ...
                                        <tr>
                                            ...
                                            <td>    
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                                                    ...
                                                    <SelectParameters>
                                                        <asp:Parameter DefaultValue="%" Name="v_sht_desc" Type="String" />
                                                        <asp:Parameter DefaultValue="%" Name="v_desc" Type="String" />
                                                    </SelectParameters>
                                                </asp:SqlDataSource>
                                            </td>
                                        </tr>
                            ...
                            <asp:GridView ID="GridView2" runat="server" AllowSorting="True" 
                                ...
                                <Columns>                                 
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_epe_amt" runat="server" Text='<%# Eval("epe_amt") %>'  DataFormatString = "{0:00.##}"
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt_epe_amt" runat="server" Enabled="true"  Style="text-align:right;" DataFormatString = "{0:00.##}"
                                                onkeypress="AllowOnlyNumeric(event);"
