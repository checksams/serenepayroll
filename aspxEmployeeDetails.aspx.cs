    ...
    public partial class aspxEmployeeDetails : System.Web.UI.Page
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("employee_delete", new SqlConnection(GetConnectionString()));
        ...
        private Boolean EmployeeDtls_Update()
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@v_status", txtEmpStatus.Text));
                cmd.Parameters.Add(new SqlParameter("@v_payroll_allowed", txtPayrollAllowed.Text));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        protected void ListView1_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                Label emp_statusLabel = (Label)e.Item.FindControl("emp_statusLabel");
                Label emp_payroll_allowedLabel = (Label)e.Item.FindControl("emp_payroll_allowedLabel");
                ...
                if (emp_statusLabel.Text == "ACTIVE"){
                    ddlEmpStatus.SelectedIndex = 0;
                    txtEmpStatus.Text = "ACTIVE";
                }
                else if (emp_statusLabel.Text == "INACTIVE")
                {
                    ddlEmpStatus.SelectedIndex = 1;
                    txtEmpStatus.Text = "INACTIVE";
                }
                else{
                    ddlEmpStatus.SelectedIndex = 0; 
                    txtEmpStatus.Text = "ACTIVE";
                ...
                if (emp_payroll_allowedLabel.Text == "YES")
                {
                    ddlPayrollAllowed.SelectedIndex = 0;
                    txtPayrollAllowed.Text = "YES";
                }
                else if (emp_statusLabel.Text == "NO")
                {
                    ddlPayrollAllowed.SelectedIndex = 1;
                    txtPayrollAllowed.Text = "NO";
                }
                else
                {
                    ddlPayrollAllowed.SelectedIndex = 0;
        ...
        {
            txtEmpStatus.Text = ddlEmpStatus.SelectedValue;
            //System.Diagnostics.Debug.WriteLine("ddlGender.SelectedValue =====>" + ddlGender.SelectedValue);
        }
        protected void ddlPayAllowed_SelectedIndexChanged(object sender, EventArgs e)
        {
            txtPayrollAllowed.Text = ddlPayrollAllowed.SelectedValue;
            //System.Diagnostics.Debug.WriteLine("ddlGender.SelectedValue =====>" + ddlGender.SelectedValue);
        }
        ...
        protected void btnUpLoad_ClickOld(object sender, EventArgs e)
        {
            String path;
            path = Server.MapPath(FileUpload1.FileName).ToString();
            //path = "C:\\Imports\\" + FileUpload1.FileName;
        ...
        protected void btnSaveEmpPhoto_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("update_emp_photo", new SqlConnection(GetConnectionString()));
            int v_txt_emp_code;
        ...
        protected void DispalyImgFromDb() {
            String errMessage;
            SqlCommand cmd = new SqlCommand("get_employee_photo", new SqlConnection(GetConnectionString()));
