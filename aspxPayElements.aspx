        ...
        <tr style="height:inherit; vertical-align:top">
            ...
            <td>
                <div  style="height:inherit;">
                    ...
                    <asp:Button ID="btnPopulatePEtoEmp" runat="server"  Visible="false"
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        <SelectParameters>
                            <asp:ControlParameter ControlID="txtSearchShtDesc" DefaultValue="%" Name="v_sht_desc" PropertyName="Text" Type="String" />
                            <asp:ControlParameter ControlID="txtSearchDesc" DefaultValue="%" Name="v_desc" PropertyName="Text" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    ...
                    <asp:Panel ID="pnlEditingData" runat="server" Wrap="False" Visible="False" 
                        BackColor="#99CCFF">                        
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlType" runat="server" Width="217px">
                                            ...
                                            <asp:ListItem Value="RELIEF">RELIEF</asp:ListItem>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblDrGLCode" runat="server" Text="Debit G.L. Code : "></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDrGLCode" runat="server"  Width="217px"
                                            ToolTip="Debit G.L. Account" ></asp:TextBox>
                                    </td>
                                </tr>              
                                <tr>
                                    <td>
                                        <asp:Label ID="lblCrGLCode" runat="server" Text="Credit G.L. Code : "></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCrGLCode" runat="server"  Width="217px"
                                            ToolTip="Credit G.L. Account" ></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td >
										<asp:Button ID="btnSearch" runat="server" 
											Text="Search" Height="20px" 
											onclick="btnSearch_Click" Width="109px" BackColor="#7AC1C7" />
									</td>
                                    <td>
                                        <asp:Label ID="lblSearchShtDesc" runat="server" Text="Short Desc. : "></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSearchShtDesc" runat="server" Width="217px" Enabled="true"> </asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblSearchDesc" runat="server" Text="Description : "></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSearchDesc" runat="server" Width="400px" Enabled="true"> </asp:TextBox>
                                    </td>
								</tr>
							</table>
                    </asp:Panel>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="pel_code" 
                                        ...
                                        <Columns> 
                                            ...
                                            <asp:BoundField DataField="pel_prescribed_amt" HeaderText="Prescribed Amount" 
                                                HeaderStyle-CssClass="currencyGridColumn"
                                                SortExpression="pel_prescribed_amt" ItemStyle-HorizontalAlign="Right"/>
                                            <asp:BoundField DataField="pel_dr_gl_code" HeaderText="Dr G.L. Code" 
                                                SortExpression="pel_dr_gl_code" ItemStyle-HorizontalAlign="Right"/>
                                            <asp:BoundField DataField="pel_cr_gl_code" HeaderText="Cr G.L. Code" 
                                                SortExpression="pel_cr_gl_code" ItemStyle-HorizontalAlign="Right"/>
                                            <asp:TemplateField>                                                
                                                <HeaderTemplate>
                    ...
                    <asp:Panel ID="pnlPayrolls" runat="server" Wrap="False" Visible="false" 
                        ...
                        <table width="100%">
                            <tr>  
                                <td valign="top">                    
                                    <asp:Label ID="lblAttachPayrolls" runat="server" Text="Populate Pay Element To Payroll" 
                                    ...
                                    <asp:Button ID="btnAttachPyrll" runat="server" Text="Populate Pay Element To Payroll" 
