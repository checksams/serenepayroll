    ...
    public partial class aspxLoans : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("delete_loan_type", new SqlConnection(GetConnectionString()));
                System.Diagnostics.Debug.WriteLine("@v_txtLtCode =====>" + v_txtLtCode);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_lt_code", v_txtLtCode));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean LoanType_Update()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update_loan_types", new SqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_lt_code", v_LtCode));
                cmd.Parameters.Add(new SqlParameter("@v_sht_desc", txtShtDesc.Text));
                cmd.Parameters.Add(new SqlParameter("@v_desc", txtDesc.Text));
                cmd.Parameters.Add(new SqlParameter("@v_min_repay_prd", v_min_repay_prd));
                cmd.Parameters.Add(new SqlParameter("@v_max_repay_prd", v_max_repay_prd));
                ...
                cmd.Parameters.Add(new SqlParameter("@v_ltcode", SqlDbType.Int));
        ...
        private Boolean Rate_Update()
        {
            ...
            try
            {
                ...
                cmd = new SqlCommand("update_loan_intr_rates", new SqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_lir_code", v_lir_code));
                ...
                cmd.Parameters.Add(new SqlParameter("@v_lircode", SqlDbType.Int));
        ...
        protected void GridView2_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            cmd = new SqlCommand("delete_loan_intr_rates", new SqlConnection(GetConnectionString()));
