    ...
    public partial class aspxUserPasswordChange : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update_u", new SqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_name", v_user));
                cmd.Parameters.Add(new SqlParameter("@v_pwd", txtPassword.Text));
                cmd.Parameters.Add(new SqlParameter("@v_new_pwd", txtNewPassword.Text));
                cmd.Parameters.Add(new SqlParameter("@v_re_new_pwd", txtReEnterNewPwd.Text));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean Verify_pwd() {
            ...
            SqlCommand cmd;
            try {
                cmd = new SqlCommand("Select usr_pwd from shr_users where usr_name=@userName and usr_pwd=MD5(@pwd)", new SqlConnection(GetConnectionString()));
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add(new SqlParameter("@userName", txtUserName.Text.Trim().Replace("&nbsp;", "")));
                cmd.Parameters.Add(new SqlParameter("@pwd", txtPassword.Text.Trim().Replace("&nbsp;", "")));
                cmd.Connection.Open();
        ...
        private void IncreamentLoginAttempts()
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("update shr_users set usr_login_atempts = case when usr_login_atempts is null then 0 else usr_login_atempts end +1 where usr_name=@userName and usr_pwd=MD5(@pwd)", new SqlConnection(GetConnectionString()));
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add(new SqlParameter("@userName", txtUserName.Text.Trim().Replace("&nbsp;", "")));
                cmd.Parameters.Add(new SqlParameter("@pwd", txtPassword.Text.Trim().Replace("&nbsp;", "")));
                cmd.Connection.Open();
                ...
                cmd = new SqlCommand("Select usr_login_atempts from shr_users where usr_name=@userName and usr_pwd=MD5(@pwd)", new SqlConnection(GetConnectionString()));
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add(new SqlParameter("@userName", txtUserName.Text.Trim().Replace("&nbsp;", "")));
                cmd.Parameters.Add(new SqlParameter("@pwd", txtPassword.Text.Trim().Replace("&nbsp;", "")));
                cmd.Connection.Open();
        ...
        private void ResetLoginAttempts()
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("update shr_users set usr_login_atempts = 0 where usr_name=@userName and usr_pwd=MD5(@pwd)", new SqlConnection(GetConnectionString()));
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add(new SqlParameter("@userName", txtUserName.Text.Trim().Replace("&nbsp;", "")));
                cmd.Parameters.Add(new SqlParameter("@pwd", txtPassword.Text.Trim().Replace("&nbsp;", "")));
                cmd.Connection.Open();
