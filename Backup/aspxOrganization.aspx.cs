...
namespace SerenePayroll
{
    ...
    public partial class aspxOrganization : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                DataTable dt = this.GetData("SELECT org_code, org_desc FROM shr_organizations where org_parent_org_code is null or org_parent_org_code = 0");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try {
                ...
                SqlCommand cmd = new SqlCommand("org_delete", new SqlConnection(GetConnectionString()));

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@v_org_code", v_txtOrgCode));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        private Boolean updateOrg()
        {
            ...
            try{
                ...
                SqlCommand cmd = new SqlCommand("update_org", new SqlConnection(GetConnectionString()));
                ...
                cmd.Parameters.Add(new SqlParameter("@v_postal_address", txtPostalAddress.Text));
                cmd.Parameters.Add(new SqlParameter("@v_physical_address", txtPhysicalAddress.Text));
                cmd.Parameters.Add(new SqlParameter("@v_type", "1"));
                cmd.Parameters.Add(new SqlParameter("@v_parent_org_code", v_ParentOrgCode));
                cmd.Parameters.Add(new SqlParameter("@v_wef", txtWef.Text));
                cmd.Parameters.Add(new SqlParameter("@v_wet", txtWet.Text));
                cmd.Parameters.Add(new SqlParameter("@v_orgcode", SqlDbType.Int));
        ...
        public static void InsertMessage(MessageItem MessageItem)
        {
            ...
            SqlCommand cmd = new SqlCommand("InsertMessage", new SqlConnection(GetConnectionString()));

            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("@param3", MessageItem.Message));
            cmd.Connection.Open();
            cmd.ExecuteNonQuery();
            cmd.Connection.Close();
        ...
        public static List<MessageItem> GetMessages()
        {
            ...
            SqlCommand cmd = new SqlCommand("ShowAll", new SqlConnection(GetConnectionString()));
        ...
        private void PopulateTreeView(DataTable dtParent, int parentId, TreeNode treeNode)
        {
            foreach (DataRow row in dtParent.Rows)
            {
                ...
                if (parentId == 0)
                {
                    ...
                    DataTable dtChild = this.GetData("SELECT org_code, org_desc FROM shr_organizations WHERE org_parent_org_code = " + child.Value);
