    ...
    public partial class aspxPayrolls : System.Web.UI.Page
    {
        ...
        private Boolean Payroll_Update()
        {
            ...
            try
            {
                ...
                if (ddlPostPayroll.SelectedValue != "NO") { v_post = "YES"; }
                else { v_post = "NO"; }
                ...
                cmd.Parameters.Add(new SqlParameter("@v_post", v_post));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ddlPostPayroll.SelectedValue = GridView1.SelectedRow.Cells[15].Text.Trim().Replace("&nbsp;", "");
